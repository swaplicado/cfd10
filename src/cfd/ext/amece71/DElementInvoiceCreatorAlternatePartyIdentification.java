 ...
 */
public class DElementInvoiceCreatorAlternatePartyIdentification extends cfd.DElement {

    protected cfd.DAttributeString moAttType;

    public DElementInvoiceCreatorAlternatePartyIdentification(java.lang.String value) {
