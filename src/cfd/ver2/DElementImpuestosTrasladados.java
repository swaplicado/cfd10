...
public class DElementImpuestosTrasladados extends cfd.DElement implements DElementWithChildren {
    ...
    protected java.util.Vector<cfd.ver2.DElementImpuestoTraslado> mvEltHijosImpuestoTrasladado;
    ...
    public java.util.Vector<cfd.ver2.DElementImpuestoTraslado> getEltHijosImpuestoTrasladado() { return mvEltHijosImpuestoTrasladado; }
    ...
    public java.lang.String getElementForXml() throws Exception {
        ...
        if (mvEltHijosImpuestoTrasladado.isEmpty()) {
            throw new IllegalStateException(DElement.ERR_MSG_NODE + "'" + msName + "'" + DElement.ERR_MSG_NODE_NO_CHILD + "'" + (new cfd.ver2.DElementImpuestoTraslado().getName()) + "'.");
        }
        else {
