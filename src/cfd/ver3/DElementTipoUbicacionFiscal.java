 ...
 */
public class DElementTipoUbicacionFiscal extends cfd.DElement {
    ...
    public DElementTipoUbicacionFiscal(java.lang.String name) {
        super(name);

        moAttCalle = new DAttributeString("calle", true, 1);
        ...
        moAttMunicipio = new DAttributeString("municipio", true, 1);
        moAttEstado = new DAttributeString("estado", true, 1);
        moAttPais = new DAttributeString("pais", true, 1);
        moAttCodigoPostal = new DAttributeString("codigoPostal", true, 5, 5);
